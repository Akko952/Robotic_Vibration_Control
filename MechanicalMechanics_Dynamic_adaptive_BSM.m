function [ddL2,ddQ2,dds,ddQ3]=MechanicalMechanics_Dynamic_adaptive_BSM(x,t)
...
%dot_Jacob,除去了ds项，可能会导致det为0
A_1=[-2*cos(Q2),L2*sin(Q2),0;
    2*sin(Q2),L2*cos(Q2),0;
    0,L3*sin(Q2),-L4*cos(Q3);
    0,L3*cos(Q2),-L4*sin(Q3)
]*[dQ2*dL2;dQ2^2;dQ3^2];
